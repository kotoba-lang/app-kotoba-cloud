# shinkansen Co-Scientist Iteration 06 — UI/UX kaizen
...
|---|---|---|---|---|---|---|
| 1 | `sk-h1` | consumer | S | 1231 | +27.4 | keep one sentence beside each action; move explanation under <details> or link the guide |
| 2 | `sk-h2` | consumer | S | 1200 | +4.4 | one page-level action for refresh/retry; per-panel repeats are removed |
| 3 | `sk-h3` | consumer | S | 1169 | +3 | hide a control until its state is known, or enable it with the reason beside it — never a bare disabled button in the idle document |
...
## Delta from iteration 05 (the measurement)

overall 99.8 → **99.7** (-0.1)
