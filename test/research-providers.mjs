...
import {createSession,verifyEvent,infer,createStripeSession,verifyStripeEvent} from '../build/providers/providers.js';
...
const model='qwen3.8-flash-next-whitehacker', upstreamModel='qwen3.8-flash-next-uncensored-iq4-xs';
